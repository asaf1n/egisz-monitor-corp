Ниже представлен полный итоговый текст файла `README.md`, переработанный в строгом техническом стиле с указанием конкретных сопоставлений данных и учетных данных для доступа.
